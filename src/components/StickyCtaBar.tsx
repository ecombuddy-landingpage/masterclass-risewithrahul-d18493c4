...
const StickyCtaBar = () => {
  return <div className="fixed bottom-0 left-0 right-0 z-50 bg-primary shadow-glow border-t border-primary/20">
      <div className="container py-2 sm:py-3">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-1.5 sm:gap-3 text-primary-foreground">
          ...
          <div className="flex flex-col items-center gap-0.5 sm:gap-1">
            ...
            <a href="https://risewithrahul.creatorlabs.in/add-to-cart" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 bg-card text-primary font-bold px-6 py-2 sm:py-3 rounded-lg hover:bg-card/90 transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] shadow-glow-sm ring-2 ring-card/50 whitespace-nowrap animate-cta-shake">
              🚀 Register Now @ ₹99
